...
export const CONVENTION_CONTENT = {
  ...
  about: {
    ...
    description: "The Convention will be held in celebration of 7 years of Rwanda Cooperation, to raise awareness on the importance of partnerships in the Global South and to explore avenues to strengthen collaboration among the different stakeholders in the development landscape.",
    objectives: [
      "The creation of appropriate mechanisms to mobilize resources.",
      "Reciprocal knowledge sharing and technical assistance.",
      "The development of platforms to increase policy dialogue and build capacities among communities of practice.",
      "Stakeholder engagement with the private sector, international organizations, civil society and research institutions."
    ]
  },
  attendees: [
  ...
  outcomes: [
    "Enhanced understanding and awareness about the importance and potential of SSTrC in addressing global development challenges",
    "Strengthened institutional frameworks through exchange of good practices for more effective collaboration and coordination among countries of the Global South",
